...
INSTALLED_APPS = [
    'studiovisit.apps.StudioVisitConfig',
...
AUTH_USER_MODEL = 'studiovisit.User'
...
STRIPE_PUBLISHABLE_KEY = 'pk_test_OSRoCpbfvasV5yMdQUvwmiWd00FhuswI5v'
STRIPE_SECRET_KEY = 'sk_test_NbwyziOUjUcvkCs7L53kSILN00VmL4PeoU'
